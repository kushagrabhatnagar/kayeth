class Student
{
  ...
  Project[] projects;
  int k;
  Student(String firstName, String lastName, String line1, String ine2, String city, String state, int pinCode, int monthdob, int daydob, int yeardob, String eMail, String contactNo, int s, int p, int q)
  {
